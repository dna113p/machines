...
const { values, positionals } = parseArgs({
  options: { live: { type: "boolean", default: false } }, allowPositionals: true,
});
...
const provider: DecisionProvider = live ? jevProvider() : {
...
console.log(live ? "Live Jev classification (one API request)." : "Offline fixture: demonstrates wiring only, not classification quality.");
